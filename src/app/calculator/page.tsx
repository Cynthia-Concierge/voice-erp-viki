      ...
      <section className="text-white text-center px-4 sm:px-6 pt-8 sm:pt-10 md:pt-16 pb-10 sm:pb-14">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[15px] sm:text-[16px] md:text-[18px] leading-[25px] sm:leading-[27px] text-white/80 max-w-xl mx-auto mb-8 sm:mb-10">
            Answer 3 questions. See your annual cost number instantly &mdash; then
            book a free call to get the full breakdown and action plan.
          </p>
        </div>
      ...
      {showResults && results && (
        <section ref={resultsRef} className="text-white px-4 sm:px-6 pb-12 sm:pb-16 md:pb-20">
          <div className="max-w-2xl mx-auto">
            ...
            {/* Gate — book a call to get the full breakdown */}
            <div ref={formRef} className="bg-[#022EAD] p-6 sm:p-8">
                ...
                <p className="text-white/70 text-[14px] mb-5">
                  We&apos;ll walk you through the complete diagnostic for your {drivers}-driver DSP on a quick call:
                </p>
                <div className="space-y-2.5 mb-6">
                  {[
                    "Full cost breakdown by category — where every dollar is going",
                    `Personalized recommendations built for your setup`,
                    `How you compare to other ${benchmarks.tier}s — and what the top 10% do differently`,
                    "Your custom 90-day savings roadmap with concrete next steps",
                  ].map((item, i) => (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" disabled={submitting}
                    ...
                    {submitting ? "Submitting..." : "Book My Free Breakdown Call"}
                  </button>
                  <p className="text-white/50 text-[12px] text-center">
                    15 minutes. No pitch &mdash; just your numbers, explained.
                  </p>
                </form>
              </div>
          </div>
